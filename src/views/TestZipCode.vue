...
// import {getSixZipCode} from '@/api/common/mixin'
export default {
  // 局部注冊的組件
  components: {
    // 縣市
...
<template>
  <div class="" style="display:flex;flex-direction:column;">
    <div style="display:flex;align-items:center;">
      ...
      ></twzipcode-zipcode>
      <el-input placeholder="輸入地址" v-model="address" style="width:400px;margin-right:10px;"> </el-input>
      <el-button type="primary" @click="searchAddress" style="">查詢郵遞區號</el-button>
    </div>
    <!-- 輸入其餘地址 call 3+2 Api -->
